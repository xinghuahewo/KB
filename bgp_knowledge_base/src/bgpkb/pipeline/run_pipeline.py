...
GENERATED_REPORT_IDS_TO_CLEAN = [
    ...
    "cleaning_v2_migration_report",
    "cleaning_v2_human_acceptance_report",
...
STEPS = [
    ...
    ("解决清洗 v2 迁移差异", "resolve_cleaning_v2_migration.py"),
    ("生成清洗 v2 迁移报告", "build_cleaning_v2_migration.py"),
    ("生成清洗 v2 人工验收报告", "build_cleaning_v2_acceptance_report.py"),
    ("生成清洗 v2 发布门禁", "build_cleaning_v2_release_gate.py"),
