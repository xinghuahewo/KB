...
REPORT = paths.report_path("human_review_source_matrix_report")
...
GENERATED_BY = "src/bgpkb/pipeline/build_human_review_source_matrix.py"
...
def write_report(records):
    ...
    lines = [
        ...
        f"- JSONL 输出：`data/derived/datasets/human_review_source_matrix.jsonl`",
        f"- CSV 输出：`data/derived/datasets/human_review_source_matrix.csv`",
