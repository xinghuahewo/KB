...
阶段四 RAG PoC 可直接使用 `data/published/semantic_id_map.jsonl` 给实体、来源和 chunk 绑定 `@id`。

阶段五标准化出口可在 `data/published/jsonld_context.json` 的基础上继续扩展 SKOS、PROV-O 和 RDF 导出。
