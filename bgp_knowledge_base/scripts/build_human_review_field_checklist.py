...
REPORT = ROOT / "reports" / "human_review_field_checklist_report.md"
...
GENERATED_BY = "scripts/build_human_review_field_checklist.py"
...
def write_report(records):
    ...
    lines = [
        ...
        f"- JSONL 输出：`datasets/human_review_field_checklist.jsonl`",
        f"- CSV 输出：`datasets/human_review_field_checklist.csv`",
