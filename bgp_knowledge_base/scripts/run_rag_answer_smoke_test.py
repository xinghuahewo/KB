...
from service import llm_client, rag_answer  # noqa: E402


REPORT_PATH = ROOT / "reports" / "rag_answer_smoke_test_report.md"
DATASET_PATH = ROOT / "datasets" / "rag_answer_smoke_test_results.jsonl"
DEFAULT_QUERIES = [
    "route leak",
    "路由泄露",
    "zzzzqqqxxxx",
