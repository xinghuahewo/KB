...
SESSION_TEMPLATE_DIR = ROOT / "review_inputs" / "human_review_session_decision_templates"
DECISION_INPUT = ROOT / "review_inputs" / "human_review_decisions.csv"
...
def build_arg_parser():
    ...
    parser.add_argument("--write", action="store_true", help="实际写入 review_inputs/human_review_decisions.csv。")
