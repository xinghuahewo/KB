...
REPORT = ROOT / "reports" / "data_dictionary_report.md"
OUTPUT = PUBLISHED_DIR / "data_dictionary.json"
QUERY_SCRIPT = ROOT / "scripts" / "query_knowledge_base.py"
...
def query_commands():
    ...
    for command in QUERY_COMMANDS:
        ...
        commands.append({
            "command": f"python3 scripts/query_knowledge_base.py {command}",
