...
REPORT = ROOT / "reports" / "human_review_session_status_report.md"
...
GENERATED_BY = "scripts/build_human_review_session_status.py"
...
def write_report(records):
    ...
    lines = [
        ...
        f"- JSONL 输出：`datasets/human_review_session_status.jsonl`",
        f"- CSV 输出：`datasets/human_review_session_status.csv`",
