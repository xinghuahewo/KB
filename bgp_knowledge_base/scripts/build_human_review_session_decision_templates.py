...
OUTPUT_DIR = ROOT / "review_inputs" / "human_review_session_decision_templates"
README = OUTPUT_DIR / "README.md"
REPORT = ROOT / "reports" / "human_review_session_decision_templates_report.md"
DECISION_INPUT = "review_inputs/human_review_decisions.csv"
GENERATED_BY = "scripts/build_human_review_session_decision_templates.py"
...
def write_report(records, grouped, output_paths):
    ...
    lines = [
        ...
        f"- 模板记录数：{len(records)}",
        f"- 输出目录：`review_inputs/human_review_session_decision_templates/`",
