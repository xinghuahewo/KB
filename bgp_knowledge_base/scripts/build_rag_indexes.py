...
CONFIG = ROOT / "config" / "rag_retrieval.yaml"
CHUNKS = ROOT / "published" / "chunk_catalog.jsonl"
...
def main():
    ...
    for chunk in chunks:
        ...
        records.append({
            ...
            "generated_by": "scripts/build_rag_indexes.py",
        })
    ...
    retrieval_framework.write_json(RETRIEVAL_INDEX, {
        ...
        "semantic_identity": "published/semantic_id_map.jsonl",
