...
REPORT = ROOT / "reports" / "human_review_decision_template_report.md"
...
def write_report(records, created_decision_file):
    ...
    lines = [
        ...
        "",
        f"- 模板记录数：{len(records)}",
        f"- 模板输出：`review_inputs/human_review_decisions_template.csv`",
        f"- 人工填写文件：`review_inputs/human_review_decisions.csv`",
