...
REPORT = ROOT / "reports" / "published_integrity_report.md"
...
def query_report_counts():
    path = ROOT / "reports" / "query_examples_report.md"
...
def build_summary():
    ...
    published_counts = {
        ...
        "semantic_skipped_actions": sum(
            1 for record in load_jsonl(ROOT / "datasets" / "next_action_queue.jsonl")
            if record.get("needs_llm")
        ),
        "source_gap_items": count_jsonl(ROOT / "datasets" / "source_gap_queue.jsonl"),
        "human_review_decision_audit": count_jsonl(ROOT / "datasets" / "human_review_decision_audit.jsonl"),
        "human_review_decision_apply_preview": count_jsonl(ROOT / "datasets" / "human_review_decision_apply_preview.jsonl"),
        "human_review_input_validation": count_jsonl(ROOT / "datasets" / "human_review_input_validation.jsonl"),
        "human_review_progress": count_jsonl(ROOT / "datasets" / "human_review_progress.jsonl"),
        "human_review_field_checklist": count_jsonl(ROOT / "datasets" / "human_review_field_checklist.jsonl"),
        "human_review_source_matrix": count_jsonl(ROOT / "datasets" / "human_review_source_matrix.jsonl"),
        "human_review_task_board": count_jsonl(ROOT / "datasets" / "human_review_task_board.jsonl"),
        "human_review_handoff": count_jsonl(ROOT / "datasets" / "human_review_handoff.jsonl"),
    }

    dataset_counts = {
        "entity_evidence": count_jsonl(ROOT / "datasets" / "entity_source_evidence.jsonl"),
        "review_packets": count_jsonl(ROOT / "datasets" / "entity_review_packets.jsonl"),
        "next_actions": count_jsonl(ROOT / "datasets" / "next_action_queue.jsonl"),
        "case_observations": count_jsonl(ROOT / "datasets" / "case_observations.jsonl"),
        "glossary": count_jsonl(ROOT / "datasets" / "glossary.jsonl"),
        "human_review_workbook": count_jsonl(ROOT / "datasets" / "human_review_workbook.jsonl"),
        "human_review_decision_audit": count_jsonl(ROOT / "datasets" / "human_review_decision_audit.jsonl"),
        "human_review_decision_apply_preview": count_jsonl(ROOT / "datasets" / "human_review_decision_apply_preview.jsonl"),
        "human_review_input_validation": count_jsonl(ROOT / "datasets" / "human_review_input_validation.jsonl"),
        "human_review_progress": count_jsonl(ROOT / "datasets" / "human_review_progress.jsonl"),
        "human_review_evidence_extracts": count_jsonl(ROOT / "datasets" / "human_review_evidence_extracts.jsonl"),
        "human_review_session_queue": count_jsonl(ROOT / "datasets" / "human_review_session_queue.jsonl"),
        "human_review_session_status": count_jsonl(ROOT / "datasets" / "human_review_session_status.jsonl"),
        "human_review_field_checklist": count_jsonl(ROOT / "datasets" / "human_review_field_checklist.jsonl"),
        "human_review_source_matrix": count_jsonl(ROOT / "datasets" / "human_review_source_matrix.jsonl"),
        "human_review_task_board": count_jsonl(ROOT / "datasets" / "human_review_task_board.jsonl"),
        "human_review_handoff": count_jsonl(ROOT / "datasets" / "human_review_handoff.jsonl"),
    ...
    summary = {
        "generated_by": "scripts/build_published_integrity_report.py",
