...
REPORT_DIR = paths.report_path("human_review_session_guides")
...
def write_readme(records):
    ...
    lines = [
        ...
        "2. 如需逐 session 填写参考，可打开 `data/review_inputs/human_review_session_decision_templates/` 中对应模板。",
        ...
        "5. 填写后运行 `python3 -m bgpkb.pipeline.build_human_review_decision_audit` 审计，再按需显式应用。",
        "",
        "## 摘要",
        "",
        f"- 队列记录数：{len(records)}",
