...
REPORT = paths.report_path("readiness_report")
SUMMARY = paths.PUBLISHED_DIR / "readiness_summary.json"
...
def build_deliverables():
    ...
    source_gaps = load_jsonl(paths.DATASETS_DIR / "source_gap_queue.jsonl")
    ...
    deliverables = [
        {
            ...
            "evidence": ["data/sources/inventory/sources.csv", "data/sources/raw/", "data/derived/datasets/source_processing_status.jsonl"],
        ...
        },
        {
            ...
            "name": "BGP 清洗文本库",
            "status": status(count_files("data/corpus/cleaned/*/*.md") > 0),
            "evidence": ["data/corpus/cleaned/", "data/generated/reports/corpus/parse_report.md"],
            "count": count_files("data/corpus/cleaned/*/*.md"),
        ...
        },
        {
            ...
            "evidence": ["data/corpus/chunks/", "data/published/chunk_catalog.jsonl"],
        ...
        },
        {
            ...
            "evidence": ["data/knowledge/entities/bgp_concepts.jsonl", "data/published/entity_catalog.jsonl"],
        ...
        },
        {
            ...
            "evidence": ["data/knowledge/entities/anomaly_types.jsonl", "data/knowledge/entities/evidence_templates.jsonl"],
        ...
        },
        {
            ...
            "evidence": ["data/knowledge/entities/data_sources.jsonl", "data/published/source_catalog.jsonl"],
        ...
        },
        {
            ...
            "evidence": ["data/knowledge/entities/data_fields.jsonl", "data/knowledge/entities/evidence_templates.jsonl"],
        ...
        },
        {
            ...
            "evidence": ["data/knowledge/entities/cases.jsonl", "data/derived/datasets/case_observations.jsonl", "data/generated/reports/review/case_observation_guides/"],
        ...
        },
        {
            "id": "glossary",
            "name": "BGP 术语表",
            "status": status(count_files("data/derived/datasets/glossary.jsonl") == 1 and counts.get("entities", 0) > 0),
            "evidence": ["data/derived/datasets/glossary.jsonl", "data/published/bgp_knowledge_base.sqlite"],
            "count": len(load_jsonl(paths.DATASETS_DIR / "glossary.jsonl")),
        ...
        },
        {
            ...
            "evidence": ["data/knowledge/relationships/relationships.jsonl", "data/published/relationship_adjacency.json"],
        ...
        },
        {
            "id": "quality_report",
            "name": "质量检查报告",
            "status": status(file_exists("data/reports/gates/quality_report.md") and integrity.get("status") == "pass"),
            "evidence": ["data/reports/gates/quality_report.md", "data/reports/gates/published_integrity_report.md"],
        ...
        },
        {
            ...
            "name": "可查询发布包",
            "status": status(
                file_exists("data/published/bgp_knowledge_base.sqlite")
                and file_exists("src/bgpkb/pipeline/query_knowledge_base.py")
                and integrity.get("status") == "pass"
            ),
            "evidence": ["data/published/", "data/published/bgp_knowledge_base.sqlite", "src/bgpkb/pipeline/query_knowledge_base.py"],
        ...
        },
        {
            ...
            "evidence": ["data/generated/reports/knowledge/llm_processing_skip_report.md", "data/derived/datasets/next_action_queue.jsonl"],
        ...
        },
        {
            ...
            "evidence": ["data/derived/datasets/human_review_workbook.jsonl", "data/generated/reports/review/human_review_guides/"],
...
def build_summary():
    ...
    return {
        "generated_by": "src/bgpkb/pipeline/build_readiness_report.py",
...
def write_outputs(summary):
    ...
    lines = [
        ...
        "- JSON 输出：`data/published/readiness_summary.json`",
        "",
        "## 目标产物映射",
        "",
        "| 目标产物 | 状态 | 数量 | 证据 | 说明 |",
